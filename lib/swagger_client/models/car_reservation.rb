...
module SwaggerClient
  ...
  class CarReservation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pick_up')
        self.pick_up = attributes[:'pick_up']
      end

      if attributes.has_key?(:'drop_off')
    ...
    def list_invalid_properties
      ...
      if @pick_up.nil?
        invalid_properties.push("invalid value for 'pick_up', pick_up cannot be nil.")
      end

      if @drop_off.nil?
        invalid_properties.push("invalid value for 'drop_off', drop_off cannot be nil.")
      end
      ...
      if @car.nil?
        invalid_properties.push("invalid value for 'car', car cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @pick_up.nil?
      return false if @drop_off.nil?
    ...
    def hash
      [id, pick_up, drop_off, provider, origin, car, traveler_ids, booking_info].hash
    end
