...
module SwaggerClient
  ...
  class Geolocation
    ...
    attr_accessor :google_maps_link
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'google_maps_link')
        self.google_maps_link = attributes[:'google_maps_link']
      end
    ...
    def hash
      [latitude, longitude, google_maps_link].hash
    end
