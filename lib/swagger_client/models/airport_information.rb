...
module SwaggerClient
  ...
  class AirportInformation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'city_code')
    ...
    def list_invalid_properties
      ...
      if @city_code.nil?
        invalid_properties.push("invalid value for 'city_code', city_code cannot be nil.")
      end
    ...
    def hash
      [code, name, city_code, city_name, state, country, location, aircraft_movements, timezone].hash
    end
