...
module SwaggerClient
  ...
  class PointOfInterestResultGrades
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'yapq_grade')
        self.yapq_grade = attributes[:'yapq_grade']
      end

      if attributes.has_key?(:'city_grade')
        self.city_grade = attributes[:'city_grade']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          yapq_grade == o.yapq_grade &&
          city_grade == o.city_grade
    end
