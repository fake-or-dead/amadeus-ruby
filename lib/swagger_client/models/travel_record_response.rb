...
module SwaggerClient
  ...
  class TravelRecordResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'record_locator')
        self.record_locator = attributes[:'record_locator']
      end
      ...
      if attributes.has_key?(:'travelers')
        if (value = attributes[:'travelers']).is_a?(Array)
          self.travelers = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @record_locator.nil?
        invalid_properties.push("invalid value for 'record_locator', record_locator cannot be nil.")
      end
    ...
    def valid?
      return false if @record_locator.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          record_locator == o.record_locator &&
          header == o.header &&
          messages == o.messages &&
    ...
    def hash
      [record_locator, header, messages, travelers, reservation].hash
    end
