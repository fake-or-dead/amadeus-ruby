...
module SwaggerClient
  ...
  class FlightReservationSegment
    ...
    def hash
      [id, departs_at, arrives_at, origin, destination, marketing_airline, operating_airline, flight_number, traveler_ids, booking_info].hash
    end
