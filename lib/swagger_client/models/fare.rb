...
module SwaggerClient
  ...
  class Fare
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'total_fare')
        self.total_fare = attributes[:'total_fare']
      end
    ...
    def list_invalid_properties
      ...
      if @total_fare.nil?
        invalid_properties.push("invalid value for 'total_fare', total_fare cannot be nil.")
      end
    ...
    def valid?
      return false if @total_fare.nil?
