...
module SwaggerClient
  ...
  class FlightTrafficSearchResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'flights')
        self.flights = attributes[:'flights']
      end

      if attributes.has_key?(:'travelers')
        self.travelers = attributes[:'travelers']
      end
    ...
    def list_invalid_properties
      ...
      if @travelers.nil?
        invalid_properties.push("invalid value for 'travelers', travelers cannot be nil.")
      end
    ...
    def hash
      [destination, flights, travelers, period].hash
    end
