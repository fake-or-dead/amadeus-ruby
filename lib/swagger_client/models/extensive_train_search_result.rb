...
module SwaggerClient
  ...
  class ExtensiveTrainSearchResult
    ...
    def self.swagger_types
      {
        :'origin' => :'Station',
        :'destination' => :'Station',
        :'itineraries' => :'Array<TrainSearchItinerary>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'itineraries')
    ...
    def list_invalid_properties
      ...
      if @itineraries.nil?
        invalid_properties.push("invalid value for 'itineraries', itineraries cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @itineraries.nil?
      return true
    end
    ...
    def hash
      [origin, destination, itineraries].hash
    end
