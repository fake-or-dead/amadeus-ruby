...
module SwaggerClient
  ...
  class RailStationResponse
    ...
    def list_invalid_properties
      ...
      if @traffic.nil?
        invalid_properties.push("invalid value for 'traffic', traffic cannot be nil.")
      end
    ...
    def hash
      [id, type, name, short_name, country, location, traffic].hash
    end
